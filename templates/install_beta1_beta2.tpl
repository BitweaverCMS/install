...
{form}
	{legend legend="Upgrade from Beta 1 to Beta 2"}
		...
		<p class="control-group column-group gutters">To upgrade CLYDE Beta 1 to CLYDE Beta 2, you need to upgrade your languages package.<br />We know we said we wouldn't make any rash schema changes, but we thought that since languages weren't working anyway, nobody could possibly loose data. We hope that this does not cause too great of a problem and we appologise for messing with the schema.<p>
	...
	<div class="control-group column-group gutters">
		...
		<input type="submit" class="ink-button" name="fSubmitDbCreate" value="Install Packages" />
	</div>
