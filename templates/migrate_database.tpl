...
{form legend="Please Enter your Source and Destination Database Connection Information"}
	<input type="hidden" name="step" value="{$next_step}" />
	<input type="hidden" name="gBitDbPassword_hash" value="{$gBitDbPassword_hash}" />

	{jstabs}
		{jstab title="Source Database Information"}
			<div class="row">
				{if $error_src}
					<ul class="result">
						<li class="error">
		...
		{jstab title="Destination Database Information"}
			<div class="row">
				{if $error_dst}
					<li class="error">
						{biticon ipackage=liberty iname=error iexplain=error}
		...
		{jstab title="Migration Options"}
			...
			<div class="row">
				...
				{forminput}
					<input type="checkbox" name="stop_on_errors"{if $stop_on_errors} checked="checked"{/if} />
