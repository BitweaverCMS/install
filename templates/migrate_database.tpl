...
{form}
			...
			{legend legend="Migration options"}
				<div class="control-group column-group gutters">
					...
					{forminput}
						...
						<br />
						<input type="submit" class="ink-button" value="Update Tables List" name="fUpdateTables" />
	...
	<div class="control-group column-group gutters">
		{forminput}
			<input type="submit" class="ink-button" value="Execute Migration" name="fSubmitDatabase" />
		{/forminput}
	</div>
{/form}
