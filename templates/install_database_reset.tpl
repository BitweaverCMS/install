...
{form legend="Your database connection information"}
	...
	<div class="row">
		<p>Your database information is stored in the file '<strong>{$gBitLoc.INSTALL_PKG_PATH}kernel/config_inc.php</strong>'. If you would like to reset these settings with new ones, you will first have to delete the settings stored therein before you can connect to a different database.</p>
