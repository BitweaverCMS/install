...
{form class="form-horizontal" legend="Your database connection information"}
	...
	<div class="control-group column-group gutters">
		{forminput}
			<input type="submit" class="ink-button" name="continue_install" value="Continue {$section|default:"install"} process" />
		{/forminput}
	</div>
	...
	<div class="control-group column-group gutters">
		...
		<p class="alert alert-block">Before you hit the <strong>Reset config_inc.php file button</strong> please make sure you know what you are doing.</p>
	...
	<div class="control-group column-group gutters">
		{forminput}
			<input type="submit" class="ink-button" name="reset_config_inc" value="Reset config_inc.php file" onclick="return confirm( 'Are you absolutely sure you want to reset your configuration file?' );" />
		{/forminput}
	</div>
{/form}
