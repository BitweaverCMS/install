...
<div class="row">
	<div class="span8">
		...
		<div class="control-group column-group gutters">
			{forminput}
				{if $gBitUser->isAdmin()}
					<a class="ink-button" href="{$smart.const.INSTALL_PKG_URL}?step=4">Upgrade</a> <a class="ink-button" href="{$smart.const.INSTALL_PKG_URL}?step=3">Install Packages</a>
	...
	<div class="span3">
		<div class="content-center"><img src="{$smarty.const.INSTALL_PKG_URL}css/images/bitweaver_logo-trans.png" alt="logo" /></div>
		<ul>
